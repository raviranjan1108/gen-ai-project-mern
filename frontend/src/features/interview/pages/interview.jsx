            ...
            {open && (
                <div className='q-card__body'>
                    <div className='q-card__section'>
                        ...
                        {/* FIX: was item.intention — backend field is "intension" */}
                        <p>{item.intension}</p>
                    </div>
                    <div className='q-card__section'>
...
const RoadMapDay = ({ day }) => (
    <div className='roadmap-day'>
        <div className='roadmap-day__header'>
            {/* FIX: was <span>Day {day.day}</span> but day.day is already "Day 1" → rendered "Day Day 1" */}
...
const Interview = () => {
    ...
    // FIX: fetch is only done here, not also inside useInterview's useEffect
        ...
        <div className='interview-page'>
            <div className='interview-layout'>
                ...
                <nav className='interview-nav'>
                    ...
                    {/* FIX: removed dead duplicate button with typo (primary-buttton / no onClick) */}
                    <button
