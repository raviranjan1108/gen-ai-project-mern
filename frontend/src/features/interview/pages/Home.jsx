...
const Home = () => {
    ...
    // FIX: fetch reports on mount (was previously done inside useInterview's useEffect,
    // which caused double-fetches — now each page manages its own data loading)
    useEffect(() => {
        getReports()
    }, [getReports])
    ...
    const handleGenerateReport = async () => {
        ...
        // FIX: was crashing with data._id when result was null
        if (result?.success) {
                ...
                <div className='interview-card__body'>
                    ...
                    <div className='panel panel--left'>
                        ...
                        <textarea
                            ...
                            maxLength={5000}
                        />
                        {/* FIX: char counter was hardcoded to 0 — now shows real count */}
                    ...
                    <div className='panel panel--right'>
                        ...
                        <div className='upload-section'>
                            ...
                            <label className='dropzone' htmlFor='resume'>
                                ...
                                {/* FIX: was showing "PDF or DOCX (Max 5MB)" — backend only accepts PDF, max 3MB */}
                                <p className='dropzone__subtitle'>PDF only (Max 3MB)</p>
                                {/* FIX: removed .docx — backend rejects it */}
